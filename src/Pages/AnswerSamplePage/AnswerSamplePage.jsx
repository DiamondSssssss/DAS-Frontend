...
import TestSample from "Pages/TestSamplePage/TestSample";
import TestSampleForm from "Pages/TestSamplePage/TestSampleForm";

const AnswerSamplePage = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const res = await DocumentService.getAllAnswers(token);
      if (res) {
        setData(res);
      }
    } catch (error) {
...
export default AnswerSamplePage;
