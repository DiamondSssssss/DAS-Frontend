...
const variantClasses = {
  ...
  h4: "sm:text-[26px] md:text-[1.4rem] text-[30px]",
  h5: "font-semibold sm:text-[21px] md:text-[23px] text-[25px]",
  h6: "font-semibold sm:text-[20px] md:text-[1.1rem] text-[1.2rem]",
  body1: "font-semibold sm:text-[18px] md:text-[20px] text-[1.1rem]",
  body2: "text-[20px]",
  body3: "text-[18px]",
  body4: "text-[16px]",
